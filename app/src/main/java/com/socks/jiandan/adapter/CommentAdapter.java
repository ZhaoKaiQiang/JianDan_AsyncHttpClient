...
import com.socks.jiandan.async.Handler4CommentList;
import com.socks.jiandan.async.Handler4FreshNewsCommentList;
...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.CommentViewHolder> {
    ...
    private ArrayList<RequestHandle> mRequestHandles;
    ...
    public void loadData() {
        ...
        RequestHandle requestHandle = HttpClientProxy.get(mActivity, Commentator.getUrlCommentList(thread_key), new Handler4CommentList(new OnHttpResponseCallBack<ArrayList<Commentator>>() {
            ...
            public void onFailure(int statusCode, Throwable throwable) {
                mLoadResultCallBack.onError(LoadResultCallBack.ERROR_NET, throwable.getMessage());
            }
    ...
    public void cancelAllRequest() {
        HttpClientProxy.cancelRequest(mRequestHandles);
    }
