...
import com.socks.jiandan.async.Handler4FreshNews;
...
public class FreshNewsAdapter extends RecyclerView.Adapter<FreshNewsAdapter.ViewHolder> {
    ...
    private ArrayList<RequestHandle> requestHandles;
    ...
    public void cancelAllRequest() {
        HttpClientProxy.cancelRequest(requestHandles);
    }
